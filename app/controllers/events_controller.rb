 ...
 def tag
  ...
  def create
    ...
    respond_to do |format|
      if @event.save
        format.html { redirect_to @event, notice: 'Your new event was successfully created.' }
  ...
  private
    ...
    def event_params
      params.require(:event).permit(:image, :link, :title, :location, :date, :time, :cost, :event_type, :tag_list)
    end
end
